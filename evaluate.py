...
class Evaluator(BaseEvaluator):
    ...
    def evaluate(self):
        ...
        for scenario in range(args.num_scenarios):
            ...
            while not all(dones):
                for agent_idx in range(world.num_bots):
                    ...
                    elif agent.should_move_heuristic(state):
        ...
        self.writer_DQN.add_scalar('Total reward', total_reward_DQN, 0)
        self.writer_DDQN.add_scalar('Total reward', total_reward_DDQN, 0)
        self.writer_HybridDQN.add_scalar('Total reward', total_reward_HybridDQN, 0)
        self.writer_HybridDDQN.add_scalar('Total reward', total_reward_HybridDDQN, 0)
